...
class Consumer extends Worker
{
    ...
    public function __construct(QueueManager $manager, Dispatcher $events, ExceptionHandler $exceptions, $isDownForMaintenance)
    {
    ...
    public function daemon($connectionName, $queue, WorkerOptions $options): void
    {
        ...
        $this->channel = $connection->configurationConsume($queue)->getChannel();
